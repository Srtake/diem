...
use diem_crypto::hfs_noise::HfsNoiseError;
...
pub enum NoiseHandshakeError {
    ...
    BuildClientHandshakeMessageFailed(HfsNoiseError),
    ...
    ClientFinalizeFailed(HfsNoiseError),
    ...
    ServerParseClient(ShortHexStr, HfsNoiseError),
    ...
    BuildServerHandshakeMessageFailed(ShortHexStr, HfsNoiseError),
